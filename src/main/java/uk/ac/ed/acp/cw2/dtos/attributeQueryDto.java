...
public class attributeQueryDto {
  @NotNull
  @Pattern(regexp = "cooling|heating|capacity|maxMoves|costPerMove|costInitial|costFinal|id")
  ...
  public boolean isOperatorValidForBooleanAttributes() {
    if (attribute == null || operator == null || value == null) {
      // @NotNull will handle null values but is triggered later than this assertion - prevent this
      // assertion throwing null pointer exception
      return true;
    }
