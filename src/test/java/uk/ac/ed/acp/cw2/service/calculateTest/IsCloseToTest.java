...
public class IsCloseToTest {
    ...
    void testIsCloseTo() {
        ...
        assertTrue(Calculate.isCloseTo(new DistanceDto(p1, p1)));
        ...
        assertTrue(Calculate.isCloseTo(new DistanceDto(a2, b2)));
        ...
        double d = Calculate.calculateDistance(new DistanceDto(a3,b3));
        ...
        assertFalse(Calculate.isCloseTo(new DistanceDto(a4, b4)));
        ...
        assertTrue(Calculate.isCloseTo(new DistanceDto(a5, b5)));
        ...
        d = Calculate.calculateDistance(new DistanceDto(a6, b6));
        assertTrue(Math.abs(d - 0.00015) < 1e-12);
        ...
        boolean ab = Calculate.isCloseTo(new DistanceDto(p7a, p7b));
        boolean ba = Calculate.isCloseTo(new DistanceDto(p7b, p7a));
        assertEquals(ab, ba);

        // Test 8: Far apart points
        PositionDto a8 = new PositionDto(-3.20, 55.94);
        PositionDto b8 = new PositionDto(-3.10, 55.84);
        assertFalse(Calculate.isCloseTo(new DistanceDto(a8, b8)));
        ...
        assertTrue(Calculate.isCloseTo(new DistanceDto(a9, b9)));
        ...
        assertTrue(Calculate.isCloseTo(new DistanceDto(a10, b10)));
        ...
        d = Calculate.calculateDistance(new DistanceDto(a11, b11));
        assertTrue(Math.abs(d-0.00015)<1e-12);

        // Test 12: NaN value
        PositionDto a12 = new PositionDto(Double.NaN, 55.946233);
        PositionDto b12 = new PositionDto(-3.192473, 55.946233);
        assertFalse(Calculate.isCloseTo(new DistanceDto(a12, b12)));
        ...
        assertFalse(Calculate.isCloseTo(new DistanceDto(a13, b13)));
        ...
        assertFalse(Calculate.isCloseTo(new DistanceDto(a14, b14)));

        // Test 15: Null DistanceDto
        assertThrows(NullPointerException.class, () -> Calculate.isCloseTo(null));

        // Test 16: Null positions inside DistanceDto
        assertThrows(NullPointerException.class,
                () -> Calculate.isCloseTo(new DistanceDto(null, new PositionDto(-3.19, 55.94))));
        assertThrows(NullPointerException.class,
                () -> Calculate.isCloseTo(new DistanceDto(new PositionDto(-3.19, 55.94), null)));
        ...
        assertTrue(Calculate.isCloseTo(new DistanceDto(a17, b17)));
    }
}
